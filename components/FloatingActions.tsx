  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] p-3 text-white shadow-lg transition-transform hover:scale-105"
      >
      ...
      <a
        ...
        aria-label="Call Better Measure"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-coral p-3 text-white shadow-lg transition-transform hover:scale-105"
      >
        <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor" aria-hidden="true">
